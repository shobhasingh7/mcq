...
public class QuestionService {
    ...
    public QuestionService() {
        loadQuestionsFromDirectory("questions-by-topic/*.json");
    }
    ...
    private void loadQuestionsFromDirectory(String resourcePattern) {
        try {
            ...
            throw new IllegalStateException("Unable to load questions from JSON resources", e);
        }
    }
